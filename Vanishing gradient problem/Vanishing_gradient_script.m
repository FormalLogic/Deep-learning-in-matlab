%% Introduction 
% This matlab script will focus on image classification for CIFAR-10. A
% network with 4 hidden layers with 20 neurons each will be constructed.
% The following code will plot the learning rate for each layer and check
% the effect known as 'vanishing gradient.' Preload the trained model into
% matlab and run section 'Plot learning rate' and 'Plot loss.' Or train the
% network from scratch by running section 'Construct network and training'
